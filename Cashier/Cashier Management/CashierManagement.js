...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener('keydown', (e) => {
        if (e.key === 'Escape') { closeModal(); closeOnsiteModal(); closePaymentDueModal(); closeLogoutModal(); closeHistoryModal(); }
    });
});
...
document.addEventListener('DOMContentLoaded', () => {
    document.querySelectorAll('.nav-link[data-view]').forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            // Update topbar title
            const titles = { payments: 'Proof of Payment Review', history: 'Transaction History' };
