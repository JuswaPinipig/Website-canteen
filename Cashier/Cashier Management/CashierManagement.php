...
require_once __DIR__ . '/../../Cashier/Config/db.php';   // provides $pdo (PDO instance)
...
<head>
    ...
    <link rel="stylesheet" href="CashierManagement.css">
</head>
<body>
    ...
    <aside class="sidebar">
        <div class="sidebar-logo">
            <div class="logo-img-wrap">
                <img src="../Cashier Management/Cashier Media/school no bg.png" alt="School Logo" id="school-logo">
            </div>
            <div class="logo-text">
...
window.APP_CONFIG = {
    ...
    loginUrl:     '/Login/Maininterface.html',
    proofBaseUrl: '/Student/student enrollment/',
...
<script src="CashierManagement.js"></script>
